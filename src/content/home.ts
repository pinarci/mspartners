...
const englishHome = {
  hero: {
    eyebrow: "Virginia-Based Independent Global Advisory",
    title: company.slogan,
    description: "MS Partners combines Virginia-based corporate responsibility with on-the-ground execution to turn complex international trade, investment and financing requirements into clear, secure and sustainable solutions.",
  ...
  introduction: {
    ...
    title: "Virginia-based accountability with practical field execution.",
    body: [
      "MS Partners is a Virginia-based independent global advisory company established to transform complex international trade processes into clear, secure and sustainable solutions.",
      "The company combines Virginia-based corporate responsibility with local execution in developing sourcing and commercial centers, helping clients coordinate cross-border requirements without the immediate need to establish a local entity in each market.",
    ],
    principle: "Virginia-based accountability. Local field execution. Independent review.",
  ...
  operatingModel: {
    ...
    title: "Virginia-based responsibility. Local execution where it matters.",
    body: "Our structure combines a Virginia-based corporate platform with local coordination and field capability in Türkiye and relevant international markets. This allows clients to address cross-border requirements through one coordinated relationship rather than establishing an immediate local presence in every jurisdiction.",
