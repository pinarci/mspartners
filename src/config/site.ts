...
export const siteMetadata = {
  ...
  description: "Virginia-based independent global advisory for de-risking complex cross-border trade, investment and financing requirements.",
} as const;
...
export const pageMetadata = {
  ...
  about: {
    title: "About Us",
    description: "Learn how MS Partners combines Virginia-based accountability with local field execution and independent review.",
  },
  services: {
    title: "Services",
